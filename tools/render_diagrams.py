...
def architecture():
    ...
    # The three lines of the second label are data.json's three top-level
    # keys, in order, so the box and the file read the same way round.
    opa = d.box(790, pdp.cy - 31, 340, 62,
                ["OPA 1.19.0 :8181", "authz.rego · the rules",
                 "data.json · your tools, purposes and limits"], "core", "hex")
