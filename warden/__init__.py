...
Kept as a package (not a bare directory), mirroring the demo package's own
__init__.py, so that warden/pyproject.toml's explicit [tool.setuptools]
packages list can name it.
